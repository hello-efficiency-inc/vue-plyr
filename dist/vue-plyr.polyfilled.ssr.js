'use strict';Object.defineProperty(exports,'__esModule',{value:true});var commonjsGlobal$1 = typeof globalThis !== 'undefined' ? globalThis : typeof window !== 'undefined' ? window : typeof global !== 'undefined' ? global : typeof self !== 'undefined' ? self : {};
...
var URLSearchParamsState = function (init) {
  ...
  if (init !== undefined) {
    if (isObject$2(init)) this.parseObject(init);else this.parseQuery(typeof init == 'string' ? charAt$2(init, 0) === '?' ? stringSlice$4(init, 1) : init : toString_1(init));
  }
};
  ...
  parseObject: function (object) {
    ...
    if (iteratorMethod) {
      ...
      while (!(step = functionCall(next, iterator)).done) {
        ...
        if ((first = functionCall(entryNext, entryIterator)).done || (second = functionCall(entryNext, entryIterator)).done || !functionCall(entryNext, entryIterator).done) throw TypeError$7('Expected sequence with length 2');
        push$5(this.entries, {
...
var push$4 = functionUncurryThis(test.push); // IE8-
...
}, !SPLIT_WORKS_WITH_OVERWRITTEN_EXEC, UNSUPPORTED_Y);var $assign = Object.assign; // eslint-disable-next-line es/no-object-defineproperty -- required for testing
...
var stringPunycodeToAscii = function (input) {
  var encoded = [];
  var labels = split$1(replace$3(toLowerCase$1(input), regexSeparators, '\u002E'), '.');
  var i, label;
...
addToUnscopables('includes');var TypeError$4 = global_1.TypeError;
...
});var RangeError$1 = global_1.RangeError; // `String.prototype.repeat` method implementation
...
var push = functionUncurryThis([].push); // `Object.{ entries, values }` methods implementation
...
addToUnscopables(FIND_INDEX);var _excluded = ["premium", "referrerPolicy"];
  ...
  Object.keys(source).forEach(function (key) {
    if (is.object(source[key])) {
      if (!Object.keys(target).includes(key)) {
        Object.assign(target, _defineProperty$2({}, key, {}));
      }

      extend(target[key], source[key]);
    } else {
      Object.assign(target, _defineProperty$2({}, key, source[key]));
    }
  });
...
function triggerEvent(element) {
  ...
  var event = new CustomEvent(type, {
    bubbles: bubbles,
    detail: _objectSpread2$1(_objectSpread2$1({}, detail), {}, {
      plyr: this
    })
  }); // Dispatch the event
...
var standardRatios = [[1, 1], [4, 3], [3, 4], [5, 4], [4, 5], [3, 2], [2, 3], [16, 10], [10, 16], [16, 9], [9, 16], [21, 9], [9, 21], [32, 9], [9, 32]].reduce(function (out, _ref5) {
  ...
  return _objectSpread2$1(_objectSpread2$1({}, out), {}, _defineProperty$2({}, x / y, [x, y]));
...
var controls = {
  ...
  createLabel: function createLabel(key) {
    ...
    var attributes = _objectSpread2$1(_objectSpread2$1({}, attr), {}, {
...
var ui = {
  ...
  migrateStyles: function migrateStyles() {
    ...
    Object.values(_objectSpread2$1({}, this.media.style)) // We're only fussed about Plyr specific properties
    .filter(function (key) {
...
var vimeo = {
  ...
  ready: function ready() {
    ...
    var params = buildUrlParams(_objectSpread2$1(_objectSpread2$1({
